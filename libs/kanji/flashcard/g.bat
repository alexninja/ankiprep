...
copy /Y __OUT__\kanji\flashcard\flashcard.css  ..\..\..\..\_ankiprep\__OUT__\kanji\flashcard
copy /Y __OUT__\kanji\flashcard\flashcard.js   ..\..\..\..\_ankiprep\__OUT__\kanji\flashcard
