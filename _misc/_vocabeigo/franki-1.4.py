...
# $Revision: 1.4 $ $Date: 2010/08/30 04:48:43 $
# http://ichi2.net/anki/ContribFugounashi#franki
...
sys.path.append("c:\Program Files\Anki\lib\shared_zip") # windows libanki and deps
import anki

locale.setlocale(locale.LC_ALL, "")
code=locale.getpreferredencoding()

version="franki-" + re.sub(r"\$Rev.sion: (.*) \$","\\1","$Revision: 1.4 $") + " libanki-" + anki.version
parser = optparse.OptionParser(usage="usage: %prog options\n-h for help\nsee http://ichi2.net/anki/ContribFugounashi#franki for more info", version=version)
